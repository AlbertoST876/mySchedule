    ...
    <body>
        ...
        <main>
            <form class="m-12" action="" method="post">
                ...
                <div class="mb-6">
                    <input class="block sm:inline-block px-5 py-3 mb-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto text-center" type="submit" name="register" value="@lang("messages.register")">
                    <a class="block sm:inline-block px-5 py-3 mb-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto text-center" href="{{ route("login") }}">@lang("messages.login")</a>
                </div>
            </form>
        </main>
    </body>
