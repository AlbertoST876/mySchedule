            ...
            <div class="mx-6 my-12 lg:mx-24 lg:my-12">
                ...
                <div class="my-8">
                    ...
                    <form action="{{ route("settings.update") }}" method="post" enctype="multipart/form-data">
                        ...
                        <input class="px-5 py-3 mr-2 mb-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm cursor-pointer focus:outline-none" type="submit" name="changeProfileImg" value="@lang("app.change")">
                                ...
                                <div class="relative w-full h-full max-w-2xl md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow">
                                        ...
                                        <div class="p-4 flex items-center space-x-2 border-t border-gray-200 rounded-b">
                                            <input class="mr-2 my-2 px-5 py-3 focus:outline-none text-white bg-red-700 hover:bg-red-800 cursor-pointer focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm" type="submit" name="deleteProfileImg" value="@lang("app.delete")">
                ...
                <div class="my-8">
                    <h2 class="mb-6 text-3xl font-extrabold">@lang("app.change_email")</h2>
                    ...
                    <form action="{{ route('settings.update') }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="block w-full md:w-3/4 lg:w-2/4 xl:w-1/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5" type="email" name="email" value="{{ auth() -> user() -> email }}" disabled>
                        </div>

                        <div class="mb-4">
                            <label class="mb-2 block text-sm font-medium text-gray-900" for="new_email">@lang("app.new_email"):</label>
                            <input class="block w-full md:w-3/4 lg:w-2/4 xl:w-1/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5" type="email" name="new_email" required>

                            @include("layouts.error", ["field" => "new_email"])
                        </div>

                        <div class="mb-4">
                            <label class="mb-2 block text-sm font-medium text-gray-900" for="password">@lang("app.password"):</label>
                            <input class="block w-full md:w-3/4 lg:w-2/4 xl:w-1/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5" type="password" name="password" required>

                            @include("layouts.error", ["field" => "password"])
                        </div>

                        <input class="px-5 py-3 mr-2 mb-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm cursor-pointer focus:outline-none" type="submit" name="changeEmail" value="@lang("app.change")">
                    </form>
                </div>
                ...
                <div class="my-8">
                    ...
                    <form action="{{ route("settings.update") }}" method="post">
                        ...
                        <input class="px-5 py-3 mr-2 mb-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm cursor-pointer focus:outline-none" type="submit" name="changeTimezone" value="@lang("app.change")">
                    </form>
                </div>
            </div>
        </main>
