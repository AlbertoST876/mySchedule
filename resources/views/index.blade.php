                ...
                <div>
                    ...
                    @guest
                        <div class="flex items-center justify-center my-8">
                            <a class="mr-8 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none" href="{{ route("login") }}">Iniciar Sesión</a>
                            <a class="ml-8 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none" href="{{ route("register") }}">Registrarse</a>
                        </div>
                    @endguest
                </div>
