        ...
        <main>
            <div class="mx-6 my-12 lg:mx-24 lg:my-12">
                <form action="{{ route("events.update") }}" method="post">
                    ...
                    <div class="mb-6">
                        <label class="mb-2 block text-sm font-medium text-gray-900" for="date">Fecha y Hora</label>
                    ...
                    <input class="mr-2 mb-2 mt-6 px-5 py-3 focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm" type="submit" name="edit" value="Editar">
                </form>
