<footer class="px-6 py-8 bg-slate-100 rounded-lg shadow lg:flex lg:justify-between">
    <span class="block lg:inline-block text-sm text-gray-500">©{{ date("Y") }} <a href="{{ route("index") }}" class="hover:underline">@lang("messages.title")</a>. @lang("messages.all_rights_reserved")</span>
